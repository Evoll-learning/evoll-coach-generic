    ...
    switch(step) {
      ...
      case 3:
        return (
          <div className="space-y-6 animate-fade-in">
            <div>
              <h2 className="text-3xl font-bold text-slate-900 mb-2">Tu Rol en tu Organización</h2>
        ...
        return (
          <div className="space-y-6 animate-fade-in">
            <div>
              ...
              <p className="text-slate-600">Alineación con los valores de tu organización</p>
            </div>
            <Card className="border-2 border-blue-100 bg-blue-50/50 mb-6">
              <CardHeader>
                <CardTitle className="text-blue-900">Valores y Compromiso</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  {[
            ...
            <div>
              ...
              <Textarea 
                placeholder="Describe tu compromiso personal con los valores de tu organización..."
